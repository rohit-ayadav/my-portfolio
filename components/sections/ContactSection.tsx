                    ...
                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a href={personalInfo.twitter} target="_blank" rel="noopener noreferrer" className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-gray-700 dark:text-gray-200 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500 transition-colors">
